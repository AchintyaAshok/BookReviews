...
//	Member Variables
	...
	/*	Constructor for the AmazonSearch Class. The constructor expects 3 parameters: a search index,
		...
		Correct Search Index/Parameter combinations can be found on Amazon's ItemSearch Page. The last
		parameter specifices whether the search is an ItemSearch or ItemLookup (their use cases are different)
		By default, the AmazonSearch class will perform an ItemSearch, unless the last parameter is 
		either SearchType::ITEM_LOOKUP or false.		*/
